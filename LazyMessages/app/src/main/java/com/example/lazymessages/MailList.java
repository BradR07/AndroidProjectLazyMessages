 ...
 */
public class MailList extends AppCompatActivity implements OnMailClickListener {
...
//        messagelist.add(D);
    ...
    /**
     * onClick sur le bouton 'info", renvoi vers la vue DetailMail
     * @param m un mail
     */
    @Override
    public void onMailClick(Mails m) {

        Intent DetailMailIntent = new Intent(MailList.this, DetailMail.class);
